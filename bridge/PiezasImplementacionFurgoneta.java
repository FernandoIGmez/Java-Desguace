 ...
 * @author nano
 */
public class PiezasImplementacionFurgoneta extends PiezasImplementacion{

    public PiezasImplementacionFurgoneta(DatosPrograma d) {
        datos=d;
    ...
    public ArrayList<Pieza> getPiezas() {
        ...
        for (int i=0 ; i< getDatos().getListaPiezas().size(); i++){
            if (getDatos().getListaPiezas().get(i).getTipoVehiculo().equals("Furgoneta")){
