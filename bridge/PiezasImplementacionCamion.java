 ...
 * @author nano
 */
public class PiezasImplementacionCamion extends PiezasImplementacion{

    public PiezasImplementacionCamion (DatosPrograma d) {
        datos=d;
    ...
    public ArrayList<Pieza> getPiezas() {
        ...
        for (int i=0 ; i< getDatos().getListaPiezas().size(); i++){
            if (getDatos().getListaPiezas().get(i).getTipoVehiculo().equals("Camion")){
