 ...
 * @author nano
 */
public class PiezasImplementacionTurismo extends PiezasImplementacion{

    public PiezasImplementacionTurismo(DatosPrograma d) {
        datos=d;
    ...
    public ArrayList<Pieza> getPiezas() {
        ...
        for (int i=0 ; i< getDatos().getListaPiezas().size(); i++){
            if (getDatos().getListaPiezas().get(i).getTipoVehiculo().equals("Turismo")){
